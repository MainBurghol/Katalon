...
WebUI.verifyElementVisible(findTestObject('ContentLibraries/Created at Inside Table'))

WebUI.verifyElementVisible(findTestObject('ContentLibraries/Updated at Inside Table'))
