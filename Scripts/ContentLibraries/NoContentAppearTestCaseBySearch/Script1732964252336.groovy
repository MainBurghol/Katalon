...
WebUI.sendKeys(findTestObject('ContentLibraries/SearchBar'), 'FFF')

WebUI.delay(5)

WebUI.verifyElementText(findTestObject('ContentLibraries/No Content libraries'), 'No Content libraries')
