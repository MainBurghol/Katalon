...
WebUI.click(findTestObject('ContentLibraries/ChangeLanugage'))

WebUI.click(findTestObject('ContentLibraries/ChangeToArabic'))

WebUI.delay(3)

WebUI.click(findTestObject('ContentLibraries/ChangeLanugage'))

WebUI.click(findTestObject('ContentLibraries/ChangeToEnglish'))
