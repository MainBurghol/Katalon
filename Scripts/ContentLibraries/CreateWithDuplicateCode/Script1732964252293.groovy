...
String MyCode = WebUI.getText(findTestObject('ContentLibraries/FirstElementCode'))
...
WebUI.sendKeys(findTestObject('ContentLibraries/ContentLibraryCreation/code'), MyCode)
...
WebUI.verifyElementText(findTestObject('ContentLibraries/ContentLibraryCreation/CodeDuplication'), 'The code has already been taken.')
